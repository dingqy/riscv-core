...
connect_bd_intf_net [get_bd_intf_pins slave_0/S_AXI ] [get_bd_intf_pins axi_pwm_0/M00_AXI]
	# Create port connections
	connect_bd_net -net aclk_net [get_bd_ports ACLK] [get_bd_pins slave_0/ACLK] [get_bd_pins axi_pwm_0/M00_AXI_ACLK]
	connect_bd_net -net aresetn_net [get_bd_ports ARESETN] [get_bd_pins slave_0/ARESETN] [get_bd_pins axi_pwm_0/M00_AXI_ARESETN]
	connect_bd_net -net init_axi_txn_00 [get_bd_ports M00_AXI_INIT_AXI_TXN] [get_bd_pins axi_pwm_0/M00_AXI_INIT_AXI_TXN]
	connect_bd_net -net error_00 [get_bd_ports M00_AXI_ERROR] [get_bd_pins axi_pwm_0/M00_AXI_ERROR]
	connect_bd_net -net txn_done_00 [get_bd_ports M00_AXI_TXN_DONE] [get_bd_pins axi_pwm_0/M00_AXI_TXN_DONE]
...
connect_bd_intf_net [get_bd_intf_pins slave_1/S_AXI ] [get_bd_intf_pins axi_pwm_0/M01_AXI]
	# Create port connections
	connect_bd_net -net aclk_net [get_bd_ports ACLK] [get_bd_pins slave_1/ACLK] [get_bd_pins axi_pwm_0/M01_AXI_ACLK]
	connect_bd_net -net aresetn_net [get_bd_ports ARESETN] [get_bd_pins slave_1/ARESETN] [get_bd_pins axi_pwm_0/M01_AXI_ARESETN]
	connect_bd_net -net init_axi_txn_11 [get_bd_ports M01_AXI_INIT_AXI_TXN] [get_bd_pins axi_pwm_0/M01_AXI_INIT_AXI_TXN]
	connect_bd_net -net error_11 [get_bd_ports M01_AXI_ERROR] [get_bd_pins axi_pwm_0/M01_AXI_ERROR]
	connect_bd_net -net txn_done_11 [get_bd_ports M01_AXI_TXN_DONE] [get_bd_pins axi_pwm_0/M01_AXI_TXN_DONE]
