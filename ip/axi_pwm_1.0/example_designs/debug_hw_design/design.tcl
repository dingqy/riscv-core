...
proc create_ipi_design { offsetfile design_name } {
	...
	# Connect all clock, reset & status pins of axi_pwm_0 master interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_mem_interconnect/S00_AXI] [get_bd_intf_pins axi_pwm_0/M00_AXI]
	connect_bd_net [get_bd_pins axi_pwm_0/m00_axi_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins axi_pwm_0/m00_axi_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_net [get_bd_pins axi_pwm_0/m00_axi_txn_done] [get_bd_pins xlconcat_0/In0]
	connect_bd_net [get_bd_pins axi_pwm_0/m00_axi_error] [get_bd_pins xlconcat_0/In1]
	connect_bd_net [get_bd_pins axi_pwm_0/m00_axi_init_axi_txn] [ get_bd_pins slice_block/Dout0 ]
	connect_bd_intf_net [get_bd_intf_pins axi_mem_interconnect/S01_AXI] [get_bd_intf_pins axi_pwm_0/M01_AXI]
	connect_bd_net [get_bd_pins axi_pwm_0/m01_axi_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins axi_pwm_0/m01_axi_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_net [get_bd_pins axi_pwm_0/m01_axi_txn_done] [get_bd_pins xlconcat_0/In2]
	connect_bd_net [get_bd_pins axi_pwm_0/m01_axi_error] [get_bd_pins xlconcat_0/In3]
	connect_bd_net [get_bd_pins axi_pwm_0/m01_axi_init_axi_txn] [ get_bd_pins slice_block/Dout1 ]


	# Auto assign address
	assign_bd_address

	# Configure address param & range of axi_pwm_0 master interfaces..
	set_property range 16K [get_bd_addr_segs {jtag_axi_0/Data/SEG_axi_bram_ctrl_0_Mem0}]
	set_property range 16K [get_bd_addr_segs {axi_pwm_0/M00_AXI/SEG_axi_bram_ctrl_0_Mem0}]
	set_property range 16K [get_bd_addr_segs {axi_pwm_0/M01_AXI/SEG_axi_bram_ctrl_0_Mem0}]
	set_property -dict [list  CONFIG.C_M00_AXI_TARGET_SLAVE_BASE_ADDR {0xC0000000} CONFIG.C_M01_AXI_TARGET_SLAVE_BASE_ADDR {0xC0000100} ] [get_bd_cells axi_pwm_0]
