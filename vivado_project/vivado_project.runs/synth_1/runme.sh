...
HD_PWD='C:/Users/80939/Desktop/ELEC222-Project/riscv-soc/riscv-core/vivado_project/vivado_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MMU_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MMU_test.tcl
