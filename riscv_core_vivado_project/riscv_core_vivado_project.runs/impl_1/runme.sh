...
HD_PWD='C:/Users/80939/Desktop/ELEC222-Project/riscv-soc/riscv-core/riscv_core_vivado_project/riscv_core_vivado_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ram2ddrxadc.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ram2ddrxadc.tcl -notrace
